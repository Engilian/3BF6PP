...
//     void setColumns(QStringList lst);
//     void setRows(QStringList lst);

    void setData( QList<GraphItem> data);
    void setMinMax(float min, float max);

    void setTitleByX( QString title );
    void setTitleByY( QString title );
    void setTitleByZ( QString title );
